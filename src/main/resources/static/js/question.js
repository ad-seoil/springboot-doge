...
function nextQuestion(event) {
    ...
    const correctAnswerIndex
        = parseInt(document.getElementById('correctAnswerIndex').value);
    const chosenButton
        = document.getElementById(`choice${selectedAnswerValue}_type_tts`) || document.getElementById(`choice${selectedAnswerValue}_type_other`);
    const correctButton
        = document.getElementById(`choice${correctAnswerIndex}_type_tts`) || document.getElementById(`choice${correctAnswerIndex}_type_other`);
    ...
    fetch('/submitAnswer', {
        ...
        headers: {
            'Content-Type': 'application/x-www-form-urlencoded', // 데이터 형식은 JSON
        },
